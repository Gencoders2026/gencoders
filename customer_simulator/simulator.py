...
class CustomerSimulator:
    ...
    def _generate_customer_message(
        ...
        # ------------------------------------------------------
        # Different messages for every turn.
        # ------------------------------------------------------
        ...
        message_sets = {
            ...
            "refund_request": {
                ...
                "calm": [
                    "Hi, I received a damaged product. Could you please help me with my refund?",
                    "Hello, I need some help with a refund for the damaged product I received.",
                    "Could you please check my refund request and tell me what the next step is?"
                ],
